...
<document source="test data">
    <paragraph>
        <footnote_reference auto="1" ids="id1" refid="autolabel">
            1
    <footnote auto="1" backrefs="id1" ids="autolabel" name="autolabel">
        <label>
            1
        <paragraph>
            text
...
<document source="test data">
    <paragraph>
        ...
        <footnote_reference auto="1" ids="id1" refid="id2">
            1
    <footnote auto="1" backrefs="id1" ids="id2" name="1">
        <label>
            1
        <paragraph>
            text
...
<document source="test data">
    ...
    <footnote auto="1" backrefs="id1" ids="id3" name="1">
        <label>
            1
        <paragraph>
            Auto-numbered footnote 1.
    <footnote auto="1" backrefs="id2" ids="id4" name="2">
        <label>
            2
        <paragraph>
            Auto-numbered footnote 2.
    <footnote auto="1" backrefs="id6" ids="id5" name="3">
        <label>
            3
        <paragraph>
            Auto-numbered footnote 3.
...
<document source="test data">
    ...
    <footnote auto="1" backrefs="id3" ids="first" name="first">
        <label>
            1
        <paragraph>
            First auto-numbered footnote.
    <footnote auto="1" backrefs="id2" ids="second" name="second">
        <label>
            2
        <paragraph>
            Second auto-numbered footnote.
    <footnote auto="1" backrefs="id1 id4" ids="third" name="third">
        <label>
            3
        <paragraph>
...
<document source="test data">
    ...
    <paragraph>
        ...
        <footnote_reference auto="1" ids="id6" refname="six">
         doesn't exist.
    <footnote auto="1" backrefs="id2" ids="id7" name="1">
        <label>
            1
        <paragraph>
            Auto-numbered footnote 1.
    <footnote auto="1" backrefs="id5" ids="two" name="two">
        <label>
            2
        <paragraph>
            Auto-numbered footnote 2.
    <footnote auto="1" backrefs="id3" ids="id8" name="3">
        <label>
            3
        <paragraph>
            Auto-numbered footnote 3.
    <footnote auto="1" backrefs="id1" ids="four" name="four">
        <label>
            4
        <paragraph>
            Auto-numbered footnote 4.
    <footnote auto="1" dupname="five" ids="five">
        <label>
            5
        <paragraph>
            Auto-numbered footnote 5.
    <footnote auto="1" dupname="five" ids="id9">
        <label>
            6
...
<document source="test data">
    <paragraph>
        Mixed auto-numbered and manual footnotes:
    <footnote ids="id1" name="1">
        <label>
            1
        <paragraph>
            manually numbered
    <footnote auto="1" ids="id2" name="2">
        <label>
            2
        <paragraph>
            auto-numbered
    <footnote auto="1" ids="label" name="label">
        <label>
            3
        <paragraph>
            autonumber-labeled
...
<document source="test data">
    ...
    <paragraph>
        ...
        <footnote_reference auto="1" ids="id2" refid="id3">
            1
        .
    <footnote auto="1" backrefs="id2" ids="id3" name="1">
        <label>
            1
        <paragraph>
            Unlabeled autonumbered footnote.
    <footnote auto="1" backrefs="id1" ids="footnote" name="footnote">
        <label>
            2
        <paragraph>
...
<document source="test data">
    ...
    <paragraph>
        ...
        <footnote_reference auto="1" ids="id8" refname="eight">
         doesn't exist.
    <footnote backrefs="id3" ids="id9" name="1">
        <label>
            1
        <paragraph>
            Manually-numbered footnote 1.
    <footnote auto="1" backrefs="id2" ids="id10" name="2">
        <label>
            2
        <paragraph>
            Auto-numbered footnote 2.
    <footnote auto="1" backrefs="id1" ids="four" name="four">
        ...
        <paragraph>
            Auto-numbered footnote 4.
    <footnote backrefs="id4" ids="id11" name="3">
        <label>
            3
        <paragraph>
    ...
    <footnote auto="1" dupname="five" ids="five">
        ...
        <paragraph>
            Auto-numbered footnote 5.
    <footnote auto="1" backrefs="id5" ids="id12" name="6">
        <label>
            6
        <paragraph>
            Auto-numbered footnote 6.
    <footnote auto="1" dupname="five" ids="id13">
        <label>
            7
