...
""",
"""\
<document ids="title" name="title" source="test data">
    <title>
        Title
...
<document ids="title" name="title" source="test data">
    <title>
        Title
    <subtitle ids="subtitle" name="subtitle">
        Subtitle
    <paragraph>
        Test title & subtitle.
"""],
...
""",
"""\
<document ids="long-title" name="long title" source="test data">
    <title>
        Long    Title
...
""",
"""\
<document ids="title-1" name="title 1" source="test data">
    <title>
        Title 1
    <comment xml:space="preserve">
        Test multiple second-level titles.
...
<document ids="title" name="title" source="test data">
    ...
    <substitution_definition name="foo">
        bar
    <target ids="invisible-target" name="invisible target">
    <paragraph>
        This title should be the document title despite the
        substitution_definition.
"""],
