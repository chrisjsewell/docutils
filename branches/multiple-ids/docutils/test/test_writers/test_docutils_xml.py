...
class DocutilsXMLTestCase(unittest.TestCase, docutils.SettingsSpec):
    ...
    bodynormal = '<document ids="test" name="test" source="&lt;string&gt;"><title>Test</title><subtitle ids="subsection" name="subsection">Subsection</subtitle><paragraph>Test</paragraph><transition/><paragraph>Test.</paragraph></document>'
    bodynormal = '<document ids="test" name="test" source="&lt;string&gt;"><title>Test</title><subtitle ids="subsection" name="subsection">Subsection</subtitle><paragraph>Test</paragraph><transition/><paragraph>Test.</paragraph></document>'
    bodynewlines = '<document ids="test" name="test" source="&lt;string&gt;">\n<title>\nTest\n</title>\n<subtitle ids="subsection" name="subsection">\nSubsection\n</subtitle>\n<paragraph>\nTest\n</paragraph>\n<transition/>\n<paragraph>\nTest.\n</paragraph>\n</document>\n'
    bodyindents = '<document ids="test" name="test" source="&lt;string&gt;">\n    <title>\n        Test\n    </title>\n    <subtitle ids="subsection" name="subsection">\n        Subsection\n    </subtitle>\n    <paragraph>\n        Test\n    </paragraph>\n    <transition/>\n    <paragraph>\n        Test.\n    </paragraph>\n</document>\n'
