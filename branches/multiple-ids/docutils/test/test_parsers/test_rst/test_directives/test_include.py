...
<document source="test data">
    <section ids="include-test" name="include test">
        <title>
            Include Test
        <section ids="inclusion-1" name="inclusion 1">
            <title>
                Inclusion 1
            <paragraph>
...
<document source="test data">
    <section ids="include-test" name="include test">
        <title>
            Include Test
        <section dupname="inclusion 1" ids="inclusion-1">
            <title>
                Inclusion 1
            <paragraph>
                This file is used by 
                <literal>
                    test_include.py
                .
        <section dupname="inclusion 1" ids="id1">
            <title>
                Inclusion 1
