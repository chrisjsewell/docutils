...
<document source="test data">
    ...
    <footnote auto="1" ids="first" name="first">
        <paragraph>
            First auto-numbered footnote.
    <footnote auto="1" ids="second" name="second">
        <paragraph>
            Second auto-numbered footnote.
    <footnote auto="1" ids="third" name="third">
        <paragraph>
...
<document source="test data">
    ...
    <footnote auto="1" ids="id7">
        <paragraph>
            Auto-numbered footnote 1.
    <footnote auto="1" ids="two" name="two">
        <paragraph>
            Auto-numbered footnote 2.
    <footnote auto="1" ids="id8">
        <paragraph>
            Auto-numbered footnote 3.
    <footnote auto="1" ids="four" name="four">
        <paragraph>
...
<document source="test data">
    ...
    <footnote auto="1" dupname="five" ids="five">
        <paragraph>
            Auto-numbered footnote 5.
    <footnote auto="1" dupname="five" ids="id12">
