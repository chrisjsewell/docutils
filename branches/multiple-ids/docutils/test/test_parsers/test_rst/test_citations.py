...
<document source="test data">
    <citation ids="citation" name="citation">
        <label>
            citation
        <paragraph>
            This is a citation.
...
"""\
<document source="test data">
    <citation ids="citation1234" name="citation1234">
        <label>
            citation1234
        <paragraph>
...
"""\
<document source="test data">
    <citation ids="citation1" name="citation1">
        <label>
            citation1
        <paragraph>
            This is a citation
            on multiple lines with more space.
    <citation ids="citation2" name="citation2">
        <label>
            citation2
        <paragraph>
            This is a citation
