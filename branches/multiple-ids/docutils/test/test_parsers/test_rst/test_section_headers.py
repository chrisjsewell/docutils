...
"""\
<document source="test data">
    <section ids="long-title" name="long title">
        <title>
            Long    Title
...
"""\
<document source="test data">
    <section ids="title-containing-inline-markup" name="title containing inline markup">
        <title>
            Title containing \n\
            <emphasis>
                inline
...
"""\
<document source="test data">
    <section ids="numbered-title" name="1. numbered title">
        <title>
            1. Numbered Title
        <paragraph>
            Paragraph.
...
<document source="test data">
    ...
    <section ids="numbered-title" name="3. numbered title">
        <title>
            3. Numbered Title
        <paragraph>
            Paragraph.
...
<document source="test data">
    ...
    <section ids="hi" name="hi">
        <title>
            Hi
        <section ids="yo" name="yo">
            <title>
                Yo
            <paragraph>
                Ho
...
"""\
<document source="test data">
    <section ids="empty-section" name="empty section">
        <title>
            Empty Section
"""],
["""\
...
"""\
<document source="test data">
    <section ids="one" name="one">
        <title>
            One
        <paragraph>
            The bubble-up parser strategy conflicts with short titles
            (<= 3 char-long over- & underlines).
    <section ids="two" name="two">
        <title>
            Two
        <paragraph>
            The parser currently contains a work-around kludge.
